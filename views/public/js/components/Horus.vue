  ...
  <div>
    <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
      ...
      <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
        Live Monitoring : 
        <button v-if="status === 'connected'" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded" >  
            Connected
        </button>
        <button v-if="status === 'disconnected'" aria-hidden class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" >
            Disconnected
        </button>
    ...
    <div v-if="showLog" ><log-info :showing="showLog" :info="selectedLog" @close="showLog = false"/></div>
...
module.exports = {
  ...
  methods: {
    ...
    toggleModal: function(id){
        this.selectedLog = this.logs.find(obj => {return obj.ID === id});
