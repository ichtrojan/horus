            ...
            <div style='border-bottom: 2px solid #eaeaea'>
              <ul class='flex cursor-pointer'>
                <li class='py-2 px-6 bg-white rounded-t-lg' v-bind:class="{'text-gray-500 bg-gray-200': openTab !== 1}">
                  <a class="" v-on:click="toggleTabs(1)">Payload</a></li>
                <li class='py-2 px-6 bg-white rounded-t-lg' v-bind:class="{'text-gray-500 bg-gray-200': openTab !== 2}">
                  <a class="" v-on:click="toggleTabs(2)">Headers</a></li>
                <li class='py-2 px-6 bg-white rounded-t-lg' v-bind:class="{'text-gray-500 bg-gray-200': openTab !== 3}">
                  <a class="" v-on:click="toggleTabs(3)">Responses</a></li>
              </ul>
            </div>
